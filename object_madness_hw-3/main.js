...
const printKelly =(book)=>{
    return book[0].info
}
const printSportsCars=(sports)=>{
...
printSportsCars(cars)
//console.log(printKelly(autoMobiles))
...
//console.log(printChevrolet(cars))
//printChevrolet(cars)
...
//const buildaCity = citiesJSON.payload.cities
...
console.log(printCities(citiesJSON.payload.cities, 'NT'))
//printCities(buildaCity)
